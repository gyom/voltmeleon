...
#
# /home/alaingui/NIPS/distdrop/bin/server --model_params_desc=${HOME}/NIPS/voltmeleon/voltmeleon/config_examples/helios-svhn-7/experiment_00/server_params_desc.json --port=7503
#
# python /home/alaingui/NIPS/distdrop/bin/auto_init_server_params.py --server=127.0.0.1 --port=7503 --W_range=0.1 --b_range=0.1 --want_zero_momentum
#
