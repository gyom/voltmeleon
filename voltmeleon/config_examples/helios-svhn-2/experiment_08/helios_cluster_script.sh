...
export EXPERIMENT_DIR=${HOME}/NIPS/experiments/08
...
THEANO_FLAGS=device=gpu0,floatX=float32 stdbuf -i0 -o0 -e0 python voltmeleon_run.py --experiment_dir=config_examples/helios-svhn-2/experiment_08 --helios >> ${MOAB_JOBARRAYINDEX}_0_out &

THEANO_FLAGS=device=gpu1,floatX=float32 stdbuf -i0 -o0 -e0 python voltmeleon_run.py --experiment_dir=config_examples/helios-svhn-2/experiment_08 --helios >> ${MOAB_JOBARRAYINDEX}_1_out &
