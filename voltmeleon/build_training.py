...
def build_training(cg, error_rate, cost, step_rule,
    ...
    monitor_train = TrainingDataMonitoring(
        variables=[cost, error_rate, minibatch_timestamp]+extra_variables_to_monitor, prefix="train", every_n_batches=monitor_interval_nbr_batchess)
    ...
    if want_eval_on_test:
        ...
        monitor_test = DataStreamMonitoring(
            variables=[cost, error_rate], data_stream=data_stream_test, prefix="valid", every_n_batches=monitor_interval_nbr_batches)
