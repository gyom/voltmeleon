...
python ${HOME}/NIPS/distdrop/bin/load_server_params.py --server=127.0.0.1 --port=7401 --load_path=${HOME}/NIPS/experiments-svhn-4/experiment_05/final_params.pkl
python ${HOME}/NIPS/distdrop/bin/load_server_params.py --server=127.0.0.1 --port=7402 --load_path=${HOME}/NIPS/experiments-svhn-4/experiment_05/final_params.pkl
python ${HOME}/NIPS/distdrop/bin/load_server_params.py --server=127.0.0.1 --port=7403 --load_path=${HOME}/NIPS/experiments-svhn-4/experiment_05/final_params.pkl
python ${HOME}/NIPS/distdrop/bin/load_server_params.py --server=127.0.0.1 --port=7404 --load_path=${HOME}/NIPS/experiments-svhn-4/experiment_05/final_params.pkl
python ${HOME}/NIPS/distdrop/bin/load_server_params.py --server=127.0.0.1 --port=7405 --load_path=${HOME}/NIPS/experiments-svhn-4/experiment_05/final_params.pkl
python ${HOME}/NIPS/distdrop/bin/load_server_params.py --server=127.0.0.1 --port=7406 --load_path=${HOME}/NIPS/experiments-svhn-4/experiment_05/final_params.pkl
python ${HOME}/NIPS/distdrop/bin/load_server_params.py --server=127.0.0.1 --port=7407 --load_path=${HOME}/NIPS/experiments-svhn-4/experiment_05/final_params.pkl
