...
#
# /home/alaingui/NIPS/distdrop/bin/server --model_params_desc=${HOME}/NIPS/voltmeleon/voltmeleon/config_examples/helios-svhn-7/experiment_imagenet_serendib/server_params_desc.json --port=7000
#
